  ...
  const defaultComponents = {
    Chevron: (props: { className?: string; size?: number; disabled?: boolean; orientation?: "left" | "right" | "up" | "down" }) => {
      ...
      if (props.orientation === "left") {
        return <ChevronLeft size={iconSize} strokeWidth={2.5} className={calendarIconSizeXl} {...props} aria-hidden="true" />;
      }
      return <ChevronRight size={iconSize} strokeWidth={2.5} className={calendarIconSizeXl} {...props} aria-hidden="true" />;
    },
  };
