...
const ERROR_MESSAGES: Record<string, string> = {
  AccessDenied:
    "Tài khoản của bạn đã bị vô hiệu hóa hoặc đã bị xóa. Vui lòng liên hệ quản trị viên để được hỗ trợ.",
    ...
    try {
      ...
      if (error instanceof Error) {
        if (
          ...
          errorMessage =
            "Lỗi kết nối với server. Vui lòng kiểm tra kết nối và thử lại.";
        } else if (
            ...
            <FieldGroup>
              ...
              >
                ...
                <Flex direction="col" align="center" gap={1}>
                  <PointerHighlight>
                    <TypographyP className="text-lg md:text-xl xl:text-2xl font-bold text-primary uppercase tracking-tight">
                      Hệ thống Kết nối Phụ huynh
                    </TypographyP>
                  </PointerHighlight>
                  <TypographyP className="text-sm font-medium text-muted-foreground italic">
