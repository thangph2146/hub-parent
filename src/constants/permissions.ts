...
export const PERMISSIONS = {
  ...
  // Posts
  POSTS_VIEW: `${RESOURCES.POSTS}:${ACTIONS.VIEW}` as Permission, // Legacy - use POSTS_VIEW_ALL or POSTS_VIEW_OWN
  POSTS_VIEW_ALL: `${RESOURCES.POSTS}:${ACTIONS.VIEW_ALL}` as Permission, // Xem tất cả bài viết
  POSTS_VIEW_OWN: `${RESOURCES.POSTS}:${ACTIONS.VIEW_OWN}` as Permission, // Chỉ xem bài viết của chính mình
  ...
  NOTIFICATIONS_VIEW_ALL: `${RESOURCES.NOTIFICATIONS}:${ACTIONS.VIEW_ALL}` as Permission,
  NOTIFICATIONS_VIEW_OWN: `${RESOURCES.NOTIFICATIONS}:${ACTIONS.VIEW_OWN}` as Permission,
...
export const MENU_PERMISSIONS = {
  ...
  posts: [PERMISSIONS.POSTS_VIEW_ALL, PERMISSIONS.POSTS_VIEW_OWN],
  ...
  notifications: [PERMISSIONS.NOTIFICATIONS_VIEW, PERMISSIONS.NOTIFICATIONS_VIEW_ALL, PERMISSIONS.NOTIFICATIONS_VIEW_OWN],
  contact_requests: [PERMISSIONS.CONTACT_REQUESTS_VIEW],
  students: [PERMISSIONS.STUDENTS_VIEW, PERMISSIONS.STUDENTS_VIEW_ALL, PERMISSIONS.STUDENTS_VIEW_OWN],
