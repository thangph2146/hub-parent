...
import { withRateLimit } from "./api-security"
import { createErrorResponse } from "./api-response"
import { logger, normalizeError, getErrorMessage } from "@/utils"
...
export const createApiRoute = (
  ...
  // Use withRateLimit instead of withSecurity (which was a combination of rate limit and security headers)
  return withRateLimit(wrappedHandler, {
