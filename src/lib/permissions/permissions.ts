...
export const PERMISSIONS = {
  ...
  // Products
  PRODUCTS_VIEW: `${RESOURCES.PRODUCTS}:${ACTIONS.VIEW}` as Permission,
  PRODUCTS_CREATE: `${RESOURCES.PRODUCTS}:${ACTIONS.CREATE}` as Permission,
  PRODUCTS_UPDATE: `${RESOURCES.PRODUCTS}:${ACTIONS.UPDATE}` as Permission,
  PRODUCTS_DELETE: `${RESOURCES.PRODUCTS}:${ACTIONS.DELETE}` as Permission,
  PRODUCTS_MANAGE: `${RESOURCES.PRODUCTS}:${ACTIONS.MANAGE}` as Permission,

  // Orders
  ORDERS_VIEW: `${RESOURCES.ORDERS}:${ACTIONS.VIEW}` as Permission,
  ORDERS_CREATE: `${RESOURCES.ORDERS}:${ACTIONS.CREATE}` as Permission,
  ORDERS_UPDATE: `${RESOURCES.ORDERS}:${ACTIONS.UPDATE}` as Permission,
  ORDERS_DELETE: `${RESOURCES.ORDERS}:${ACTIONS.DELETE}` as Permission,
  ORDERS_MANAGE: `${RESOURCES.ORDERS}:${ACTIONS.MANAGE}` as Permission,

  // Gift Codes
  GIFT_CODES_VIEW: `${RESOURCES.GIFT_CODES}:${ACTIONS.VIEW}` as Permission,
  GIFT_CODES_CREATE: `${RESOURCES.GIFT_CODES}:${ACTIONS.CREATE}` as Permission,
  GIFT_CODES_UPDATE: `${RESOURCES.GIFT_CODES}:${ACTIONS.UPDATE}` as Permission,
  GIFT_CODES_DELETE: `${RESOURCES.GIFT_CODES}:${ACTIONS.DELETE}` as Permission,
  GIFT_CODES_MANAGE: `${RESOURCES.GIFT_CODES}:${ACTIONS.MANAGE}` as Permission,
} as const
...
export const MENU_PERMISSIONS = {
  ...
  gift_codes: [PERMISSIONS.GIFT_CODES_VIEW],
} as const
