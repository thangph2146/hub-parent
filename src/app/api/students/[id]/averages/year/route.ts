/**
 * API Route: GET /api/students/[id]/averages/year
 * Lấy danh sách điểm trung bình theo năm học từ external API
...
import type { StudentYearAveragesResponse } from "@/lib/api/types/student-scores"
...
export const GET = createGetRoute(getStudentYearAveragesHandler, {
