...
export const PostShare = ({ title, url, variant = "default", compact: compactProp }: PostShareProps) => {
  ...
  if (isSticky) {
    return (
      <>
        {/* Desktop Sticky - Side */}
        <div className="fixed right-6 top-32 z-50 hidden lg:flex flex-col items-center gap-2 bg-background/80 backdrop-blur-sm p-1.5 rounded-full border shadow-sm">
