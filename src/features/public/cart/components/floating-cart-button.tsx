...
export function FloatingCartButton() {
  ...
  return (
    <>
      <div className="fixed rounded-full bottom-6 right-6 z-50">
        <Button
          size="lg"
          className="relative bg-white text-foreground hover:text-primary-foreground h-14 w-14 rounded-full shadow-lg transition-shadow"
          onClick={() => {
            if (!session?.user) {
              router.push("/auth/sign-in?callbackUrl=" + encodeURIComponent(window.location.pathname))
              return
