    ...
    >
      <Flex direction="col" container padding="responsive-lg" className="h-full items-center justify-center space-y-8">
        <PointerHighlight containerClassName="w-fit" rectangleClassName="border-primary/50" pointerClassName="text-primary">
          <TypographyH2>
            <div className="text-2xl sm:text-3xl lg:text-4xl font-bold flex items-center gap-2">
        ...
        <div className="w-full relative px-8 py-6 rounded-xl bg-gradient-to-br from-primary/5 to-transparent">
          <Quote className="absolute top-0 left-0 fill-primary/10 w-8 h-8 rotate-180" />
          <TypographyP className="text-justify text-base md:text-lg lg:text-xl xl:text-2xl leading-relaxed">
          ...
          <Quote className="absolute bottom-0 right-0 fill-primary/10 w-8 h-8" />
        </div>
