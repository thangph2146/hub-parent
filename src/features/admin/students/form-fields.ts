  ...
  const fields: ResourceFormField<StudentFormData>[] = [
    {
      ...
      label: "Mã sinh viên",
      type: "text",
      placeholder: "Vd: 03012345****",
      required: true,
      description: "Mã số sinh viên là một dãy số (ví dụ: 03012345)",
    ...
    },
    {
      ...
      label: "Email",
      type: "email",
      placeholder: "Vd: 03012345@st.buh.edu.vn",
      required: false,
      description: "Email của trường cấp cho sinh viên (ví dụ: masosinhvien@st.buh.edu.vn)",
